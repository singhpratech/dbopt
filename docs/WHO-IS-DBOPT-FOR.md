...
- The static analyzer runs **102 rules** in milliseconds with a self-graded **F1 = 1.000** on our
  171-scenario corpus (covering 63 of those rules, plus 12 plan-XML/DMV checks) — so the flags it's tested on are precise, not noise.
...
- **Trust:** live-tested against SQL Server **2025**; 2014–2022 are supported static-analysis targets; static-rule self-graded **F1 = 1.000**
  across 171 tagged scenarios (63 rules covered); **never reads your data**; never auto-executes changes.
