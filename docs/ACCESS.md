...
|---|---|---|---|
| **0 — None** | No database connection at all | Static T-SQL analysis of any script or stored-proc text (104 rules: sargability, plan shape, deprecated syntax, hygiene, transactions, security, index design…). Version-aware (2014→2025). | Full, instantly. Great for code review / CI. |
