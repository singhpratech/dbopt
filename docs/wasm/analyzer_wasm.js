/* @ts-self-types="./analyzer_wasm.d.ts" */

/**
 * @param {any} input
 * @returns {any}
 */
export function analyze_json(input) {
    const ret = wasm.analyze_json(input);
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('analyzer_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
