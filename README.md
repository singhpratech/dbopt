...
- **312 eval scenarios** · precision = recall = **F1 = 1.000**. CI fails if *any* scenario fails, and separately if F1 drops below 0.95 — an aggregate alone would let a localized regression through. The harness is
