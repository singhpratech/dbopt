...
export const HELP_STEPS: { n: string; title: string; body: string }[] = [
  {
    ...
    body: "Point dbopt at an instance (host, login, database). The analyzer talks only to your server — your data leaves the box only if you pick a cloud AI model or when dbopt checks for a newer release (on launch + the UPDATES button).",
  },
  {
    n: "②",
